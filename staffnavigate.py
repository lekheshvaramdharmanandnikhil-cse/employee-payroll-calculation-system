...
def staffnavigate() :
    ...
    d.place(x=0,y=0)
    head=Label(t,text='Staff Navigate',font=('arial',30,"italic underline"),fg='black',bg='light blue')
    ...
    b=Label(t,text='SName',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    b.place(x=330,y=190)
    ...
    f=Label(t,text='Dept-No',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    f.place(x=330,y=550)
