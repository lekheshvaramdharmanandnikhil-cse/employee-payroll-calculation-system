...
def admintablenavigate() :
    t=tkinter.Tk()
    t.geometry('1300x720')
    d=Canvas(t,height=1500,width=1500,bg='blue')
    d.place(x=0,y=0)
    head=Label(t,text='Admin Table Navigate',font=('arial',30,"italic underline"),fg='black',bg='light blue')
    ...
    def close() :
        t.destroy()
    a=Label(t,text='Admin-Id',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    a.place(x=300,y=100)
    e1=Entry(t,width=20,bd=15)
    e1.place(x=530,y=100)
    b=Label(t,text='Name',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    b.place(x=300,y=190)
    e2=Entry(t,width=20,bd=15)
    e2.place(x=530,y=190)
    c=Label(t,text='Password',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    c.place(x=300,y=280)
    e3=Entry(t,width=20,bd=15)
    e3.place(x=530,y=280)
    d=Label(t,text='Email-Id',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    d.place(x=300,y=370)
