...
def stafffind() :
    ...
    d.place(x=0,y=0)
    head=Label(t,text='Staff Find',font=('arial',30,"italic underline"),fg='black',bg='light yellow')
    ...
    b=Label(t,text='SName',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    b.place(x=350,y=190)
    ...
    d=Label(t,text='Dept-No',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    d.place(x=350,y=550)
