...
def staffsalarybreakupfind() :
    t=tkinter.Tk()
    t.geometry('1300x750')
    d=Canvas(t,height=1500,width=1500,bg='yellow')
    d.place(x=0,y=0)
    head=Label(t,text='Staff Salary Breakup Find',font=('arial',30,"italic underline"),fg='black',bg='light yellow')
    ...
    b=Label(t,text='CTC',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    b.place(x=350,y=190)
    e2=Entry(t,width=20,bd=15)
    e2.place(x=550,y=190)
    c=Label(t,text='BASIC',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    c.place(x=350,y=280)
    e3=Entry(t,width=20,bd=15)
    e3.place(x=550,y=280)
    d=Label(t,text='PF',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    d.place(x=350,y=370)
    e4=Entry(t,width=20,bd=15)
    e4.place(x=550,y=370)
    x=Label(t,text='Allowance',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    x.place(x=350,y=460)
    e5=Entry(t,width=20,bd=15)
    e5.place(x=550,y=460)
    d=Label(t,text='Per Month',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    d.place(x=350,y=550)
