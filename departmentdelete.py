...
def departmentdelete() :
    ...
    d.place(x=0,y=0)
    head=Label(t,text='Department Delete',font=('arial',30,"italic underline"),fg='black',bg='white')
    ...
    a=Label(t,text='Dept-Id',font=('georgia',30,"italic underline"),bg='light pink',height=1,width=7)
    a.place(x=400,y=160)
    e1=ttk.Combobox(t)
    filldata()
