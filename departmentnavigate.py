...
def departmentnavigate() :
    t=tkinter.Tk()
    t.geometry('1300x720')
    d=Canvas(t,height=1500,width=1500,bg='blue')
    d.place(x=0,y=0)
    head=Label(t,text='Department Navigate',font=('arial',30,"italic underline"),fg='black',bg='light blue')
    ...
    def close() :
        t.destroy()
    a=Label(t,text='Dept-Id',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    a.place(x=350,y=102)
    e1=Entry(t,width=20,bd=15)
    e1.place(x=530,y=102)
    b=Label(t,text='DName',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    b.place(x=350,y=214)
    e2=Entry(t,width=20,bd=15)
    e2.place(x=530,y=214)
    c=Label(t,text='Hodname',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    c.place(x=315,y=326)
    e3=Entry(t,width=20,bd=15)
    e3.place(x=530,y=326)
    d=Label(t,text='Hodemail-Id',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    d.place(x=270,y=438)
    e4=Entry(t,width=20,bd=15)
    e4.place(x=530,y=438)
    e=Label(t,text='Special Remarks',font=('georgia',25,"italic underline"),fg='black',bg='sky blue')
    e.place(x=220,y=550)
