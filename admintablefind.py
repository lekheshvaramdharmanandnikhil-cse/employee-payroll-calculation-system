...
def admintablefind() :
    ...
    d.place(x=0,y=0)
    head=Label(t,text='Admin Table Find',font=('arial',30,"italic underline"),fg='black',bg='light yellow')
    ...
    def close() :
        t.destroy()
    a=Label(t,text='Admin-Id',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    a.place(x=350,y=100)
    e1=ttk.Combobox(t) 
    filldata()
    ...
    b=Label(t,text='Name',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    b.place(x=350,y=190)
    e2=Entry(t,width=20,bd=15)
    e2.place(x=550,y=190)
    c=Label(t,text='Password',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    c.place(x=350,y=280)
    e3=Entry(t,width=20,bd=15)
    e3.place(x=550,y=280)
    d=Label(t,text='Email-Id',font=('georgia',20,"italic underline"),fg='black',bg='light yellow')
    d.place(x=350,y=370)
